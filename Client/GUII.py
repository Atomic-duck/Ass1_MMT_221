...
class LoginWindow(Window):
    ...
    def build_window(self):
        ...
        tk.Button(self.root, text="Register",
                  command=self.Register).grid(row=4, column=0)
        tk.Button(self.root, text="Login",
                  command=self.Login).grid(row=4, column=1)
...
class ChatWindow(Window):
    ...
    def build_window(self):
        ...
        self.left_frame = Frame(self.root, bg='red',
                                width=150, height=450, pady=3)
        self.right_frame = Frame(self.root, bg='blue',
                                 width=650, height=450, pady=3)
        ...
        self.Username_Search_Frame = Frame(
            self.left_frame, bg='yellow', pady=3)
        self.Username_Search_Frame.grid_rowconfigure(0, weight=1)
        self.Username_Search_Frame.grid_columnconfigure(0, weight=1)
        self.Username_label = Label(
            self.Username_Search_Frame, text=self.client.username)
        self.Search_entry = Entry(
            self.Username_Search_Frame, text='Add people')
        ...
        self.Show_Friend_request_Frame = Frame(
            self.left_frame, bg='red', pady=3)
        ...
        self.Show_button_label = Label(
            self.Show_Friend_request_Frame, text='Chats')

        self.Friend_request_button = Button(
            self.Show_Friend_request_Frame, text='Friend_request')

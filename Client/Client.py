...
HOST = "172.20.15.172" # Server's IP: the IP address of the computer running the server
DEVICE_HOST = "172.20.0.1"# can be one of devices's DNS server
PORT = 13000
...
class Client:
    ...
    def Receive_message(self):
        ...
        return {'header': message_header, 'data': self.socket.recv(message_len).decode('utf-8')}
